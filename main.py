...
@app.post("/events")
def post_events(title: Annotated[str, Form()], 
    ...
    events_collection.insert_one({"title": title, 
...
def delete_event(event_id):
    ...
    if not delete_result.deleted_count:
        raise HTTPException(status.HTTP_404_NOT_FOUND, "Sorry, no event found to delete!")
    # Return reponse
